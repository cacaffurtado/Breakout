void mostraJogo() {
  ...
  if (vida > 0) {
    ...
    println(aux);
    println(powerupFogo1.estadoPowerup, powerupBastao1.estadoPowerup, powerupFogo2.estadoPowerup, powerupBastao2.estadoPowerup);

    if (aux >= 1) {
      powerupFogo1.update();
      powerupFogo1.colisaoBastao1();
      powerupFogo1.display1();
    }
    if (aux >= 3) {
      powerupBastao1.update();
      powerupBastao1.colisaoBastao2();
      powerupBastao1.display2();
    }
    if (aux >= 5) {
      powerupFogo2.update();
      powerupFogo2.colisaoBastao1();
      powerupFogo2.display1();
    }
    if (aux >= 7) {
      powerupBastao2.update();
      powerupBastao2.colisaoBastao2();
      powerupBastao2.display2();
    }
